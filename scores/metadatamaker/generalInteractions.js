...
function addAuthor() {
	if (aCounter < 50) {
		...
		newdiv.innerHTML += '<span class="added-author"><input type="text" class="author translit-listen" id="family_name' + aCounter + '" placeholder="Family Name">, <input type="text" class="author translit-listen" id="given_name' + aCounter + '" placeholder="Given Name"> <select name="role' + aCounter + '" id="role'  + aCounter + '"><option value="arr">arranger</option><option value="art">artist</option><option value="aut">author</option><option selected value="cmp">composer</option><option value="ctb">contributor</option><option value="edt">editor</option><option value="ill">illustrator</option><option value="lbt">librettist</option><option value="lyr">lyricist</option><option value="trl">translator</option></select></span>';
