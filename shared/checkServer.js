 ...
 * 
 * Displays a warning banner if the application is not running on the official
 * metadatamaker.library.illinois.edu server. This helps prevent users from
 * accidentally using development/test versions.
 * 
 * This file is shared across all MetadataMaker modules.
 */
