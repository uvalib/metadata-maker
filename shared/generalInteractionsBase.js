(function(global) {
  ...
  function buildDefaultAuthorMarkup(index, options) {
    ...
    markup += '<label for="given_name' + index + '" class="insert insert_given_name additional_insert" onClick=\'insertMenu("given_name' + index + '");\'>Insert Special Characters</label><br>';
    ...
    markup += '<label for="translit_' + familyId + '" class="insert insert_family_name hidden translit translit-' + familyId + '" onClick=\'insertMenu("translit_' + familyId + '");\'>Insert Special Characters</label>';
    markup += '<label for="translit_given_name' + index + '" class="insert insert_given_name hidden translit translit-' + familyId + '" onClick=\'insertMenu("translit_given_name' + index + '");\'>Insert Special Characters</label><br>';
  ...
  function buildDefaultCorporateMarkup(index, options) {
    ...
    let markup = '';
    markup += '<label for="' + blockId + '" class="insert insert_corporate_name" onClick=\'insertMenu("' + blockId + '");\'>Insert Special Characters</label><br>';
    ...
    markup += '<label for="translit_' + blockId + '" class="insert insert_translit_corporate_name hidden translit translit-' + blockId + '" onClick=\'insertMenu("translit_' + blockId + '");\'>Insert Special Characters</label><br>';
