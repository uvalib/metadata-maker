...
function addCorporate() {
	if (cCounter < 50) {
		...
		newdiv.innerHTML = '<label for="corporate_name' + cCounter + '" class="insert insert_corporate" onClick=\'insertMenu("corporate_name' + cCounter + '");\'>Insert Special Characters</label><br>';
